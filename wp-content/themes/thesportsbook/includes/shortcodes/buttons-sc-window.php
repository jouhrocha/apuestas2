...
<div id="cdf_shortcode_dialog" class="flytonic_sc_editor" title="Custom Buttons" style="display:none;">
	...
	<div>
    	...
    	<label for=""><?php _e('Button Text', 'thesportsbook'); ?></label>

    	<input class="fly_textinput" type="text" name="fly_button_text" id="text" size="40">

    	<p><?php _e('Enter Button Text', 'thesportsbook'); ?></p>
	...
	<div>
    	...
    	<label for=""><?php _e('Button URL', 'thesportsbook'); ?></label>

    	<input class="fly_textinput" type="text" name="fly_button_text" id="linkurl" size="40">

    	<p><?php _e('Enter Button URL', 'thesportsbook'); ?></p>
	...
	<div>
    	...
    	<label><?php _e('Size of Button', 'thesportsbook'); ?></label>

    	<select class="fly_textinput" name="size" id="size">

    	     	<option value="reg"><?php _e('Regular', 'thesportsbook'); ?></option>

		<option value="sm"><?php _e('Small', 'thesportsbook'); ?></option>

		<option value="med"><?php _e('Medium', 'thesportsbook'); ?></option>

               	 <option value="lg"><?php _e('Large', 'thesportsbook'); ?></option>
	...
	<div>
    	...
    	<label><?php _e('Icon', 'thesportsbook'); ?></label>

    	<select class="fly_textinput" name="icon" id="icon">

    	     	<option value="none"><?php _e('None (Default)', 'thesportsbook'); ?></option>

               	 <option value="darrow"><?php _e('Down Arrow', 'thesportsbook'); ?></option>

		<option value="info"><?php _e('Info', 'thesportsbook'); ?></option>

		<option value="error"><?php _e('Error', 'thesportsbook'); ?></option>

		<option value="check"><?php _e('Check', 'thesportsbook'); ?></option>

   		<option value="warning"><?php _e('Warning', 'thesportsbook'); ?></option>
	...
	<div>
    	...
    	<label><?php _e('Text Color', 'thesportsbook'); ?></label>

    	<select class="fly_textinput" name="text_color" id="text_color">

    	     	<option value="lgt"><?php _e('Light', 'thesportsbook'); ?></option>

                <option value="drk"><?php _e('Dark', 'thesportsbook'); ?></option>
	...
	<div>
    	...
    	<label><?php _e('Background Color', 'thesportsbook'); ?></label>

    	<select class="fly_textinput" name="bg_color" id="bg_color">

    	     	<option value="normal"><?php _e('Normal', 'thesportsbook'); ?></option>
...
<option value="black">Black</option>
		...
		<option value="custom"><?php _e('Custom', 'thesportsbook'); ?></option>
	...
	<div id="cdf_bg_color_custom" style="display:none;">
    	...
    	<label for="tag-name"><?php _e('Custom Background Color', 'thesportsbook'); ?></label>

    	<input type="text" name="bg_color_custom" id="bg_color_custom" class="cdf-bg-color-field" size="40" />

    	<p><?php _e('Select or enter a custom background color for the button', 'thesportsbook'); ?></p>
		...
		buttons: {
			...
			Ok: function() {
				...
				if (Editor == null) {
					...
					jQuery('#cdf_shortcode_dialog').data('Editor').insertContent(str);
